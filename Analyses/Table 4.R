...
hivmain <- cbind(cbind(c(tot$partstatuses[c(2:7, 1)])),
                 cbind(c(tot$n[c(2:7, 1)])),
                 cbind(rbind((100 * tot$n[2] / sum(tot$n[2:7])),
                             (100 * tot$n[3] / sum(tot$n[2:7])),
                             (100 * tot$n[4] / sum(tot$n[2:7])),
                             (100 * tot$n[5] / sum(tot$n[2:7])),
                             (100 * tot$n[6] / sum(tot$n[2:7])),
                             (100 * tot$n[7] / sum(tot$n[2:7])),
                             (100 * tot$n[1] / sum(tot$n)))),
                 cbind(c(a$n[c(2:7, 1)])),
                 cbind(rbind((100 * a$n[2] / sum(a$n[2:7])),
                             (100 * a$n[3] / sum(a$n[2:7])),
                             (100 * a$n[4] / sum(a$n[2:7])),
                             (100 * a$n[5] / sum(a$n[2:7])),
                             (100 * a$n[6] / sum(a$n[2:7])),
                             (100 * a$n[7] / sum(a$n[2:7])),
                             (100 * a$n[1] / sum(a$n)))))
hivcas <- cbind(cbind(c(b$n[c(2:7, 1)])),
                cbind(rbind((100 * b$n[2] / sum(b$n[2:7])),
                            (100 * b$n[3] / sum(b$n[2:7])),
                            (100 * b$n[4] / sum(b$n[2:7])),
                            (100 * b$n[5] / sum(b$n[2:7])),
                            (100 * b$n[6] / sum(b$n[2:7])),
                            (100 * b$n[7] / sum(b$n[2:7])),
                            (100 * b$n[1] / sum(b$n)))))

hivinst <- cbind(cbind(c(c$n[c(2:7, 1)])),
                 cbind(rbind((100 * c$n[2] / sum(c$n[2:7])),
                             (100 * c$n[3] / sum(c$n[2:7])),
                             (100 * c$n[4] / sum(c$n[2:7])),
                             (100 * c$n[5] / sum(c$n[2:7])),
                             (100 * c$n[6] / sum(c$n[2:7])),
                             (100 * c$n[7] / sum(c$n[2:7])),
                             (100 * c$n[1] / sum(c$n)))))
