...
#TABLE 5------------------------------------------------------------
  ...
  output$table5all<-renderTable({rbind(table5allpart(),table5allparttotal())})
...
output$densityplot4all<-renderPlot({
  ggplot(data=t4every, aes_string(x=artnetLong.density, group=input$x4, color=input$x4))+
    geom_density(size=1) + theme_bw() + labs(y="Density",
                                             x= "Duration",
...
output$densityplot4main<-renderPlot({
  ggplot(data=t4main, aes_string(x=artnetLong.density, group=input$x4, color=input$x4))+
    geom_density(size=1) + theme_bw()+ labs(y="Density",
                                            x="Duration",
                                            color=if(input$x4=="age.cat"){print ("Age Category")}
                                            else if(input$x4=="race.cat"){print ("Race Category")}
...
output$densityplot4casual<-renderPlot({
  ggplot(data=t4casual, aes_string(x=artnetLong.density, group=input$x4, color=input$x4))+
    geom_density(size=1) + theme_bw()+ labs(y="Density",
                                            x="Duration",
                                            color=if(input$x4=="age.cat"){print ("Age Category")}
                                            else if(input$x4=="race.cat"){print ("Race Category")}
